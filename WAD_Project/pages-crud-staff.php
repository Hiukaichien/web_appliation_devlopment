...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['newstaffname'])) {
  $newStaffName = trim($_POST['newstaffname']);

  if (empty($newStaffName)) {
    echo "<script>alert('Staff name cannot be empty.');</script>";
  } elseif ($dbhelper->staffUsernameExists($newStaffName)) {
    echo "<script>alert('The staff username already exists.');</script>";
  } else {
    $dbhelper->insertNewStaff($newStaffName, '123');
    echo "<script>alert('New staff has been successfully created with the default password 123.');</script>";
  }
}
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="pages-crud-staff.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>CRUD Staff (Cannot Update and Delete)</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item">Others</li>
          <li class="breadcrumb-item active">CRUD Staff</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
                ...
                <tbody>
                  <?php foreach ($staffList as $staff): ?>
                    <tr>
                      ...
                      <td><?= htmlspecialchars($staff['staffusername']); ?></td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
          ...
          <form method="POST">
            <div class="row mb-3">
              <label for="newstaffname" class="col-md-4 col-lg-3 col-form-label">Create Staff Name</label>
              <div class="col-md-8 col-lg-9">
                <input name="newstaffname" type="text" class="form-control" id="newstaffname" placeholder="Type here">
              </div>
            </div>
