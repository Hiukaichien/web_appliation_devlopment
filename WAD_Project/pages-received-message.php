...
<head>
  ...
  <title>Received Messages - Staff</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="pages-received-message.php">
                  ...
                  <?php else: ?>
                    <?php foreach ($messages as $message): ?>
                      <tr>
                        ...
                        <td><?php echo htmlspecialchars($message['customerid']); ?></td>
                        <td><?php echo htmlspecialchars($message['customerusername']); ?></td>
                        <td><?php echo htmlspecialchars($message['customeremail']); ?></td>
                        <td><?php echo htmlspecialchars($message['subject']); ?></td>
                        <td class="truncate" data-fulltext="<?php echo htmlspecialchars($message['message']); ?>"><?php echo htmlspecialchars($message['message']); ?></td>
                        <td><?php echo htmlspecialchars($message['date']); ?></td>
                        <td style="text-align: center;">
                          <input type="checkbox" class="form-check-input" style="margin-left: 10px;" <?php echo $message['status'] == 1 ? 'checked' : ''; ?> onchange="updateStatus(<?php echo $message['id']; ?>, this.checked)">
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  <?php endif; ?>
