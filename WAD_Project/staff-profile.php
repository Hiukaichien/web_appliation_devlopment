...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['fullName'])) {
  ...
  } elseif ($newName === $username) {
    echo "<script>alert('New name cannot be the same as the current username');</script>";
  } elseif (is_string($newName) && $newName !== $username) {
    $dbhelper->updateStaffUsername($username, $newName);
    $_SESSION['username'] = $newName;
    $username = $newName;
  }
}

if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['currentPassword'], $_POST['newPassword'], $_POST['renewPassword'])) {
  $currentPassword = trim($_POST['currentPassword']);
  $newPassword = trim($_POST['newPassword']);
  $renewPassword = trim($_POST['renewPassword']);

  if (empty($currentPassword) || empty($newPassword) || empty($renewPassword)) {
    echo "<script>alert('All password fields must be filled.');</script>";
  } elseif (!$dbhelper->validateStaffLogin($username, $currentPassword)) {
    ...
    $dbhelper->updateStaffPassword($username, $newPassword);
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Edit Name</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">I am a dedicated agricultural professional with a strong passion for cultivating sustainable practices and driving productivity in the farming industry. With hands-on experience in managing agricultural operations, I specialize in ensuring the efficient growth and care of crops and livestock while embracing innovative technologies and eco-friendly approaches.</p>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Neuc</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Job</div>
                    <div class="col-lg-9 col-md-8">General Staff</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Blok B&C, Lot, 5, Seksyen 10, Jalan Bukit, Taman Bukit Mewah, 43000 Kajang, Selango</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8">+60 12-3456789</div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="POST" action="">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="Type here">
                      </div>
                    </div>
